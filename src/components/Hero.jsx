...
const Hero = () => {
  ...
  return (
    <div className="relative w-screen overflow-x-hidden h-dvh">
        ...
        { isLoading && (
            <div className="flex-center absolut z-[100] w-screen overflow-hidden bg-violet-50"> 
      ...
      <div id="video-frame" className="relative z-10 w-screen overflow-hidden rounded-lg bg-blue-75 h-dvh">
            ...
            <div className="absolute top-0 left-0 z-40 size-full">
                <div className="px-5 mt-24 sm:px-10">
                    <h1 className="text-blue-100 special-font hero-heading">redfi<b>n</b>e</h1>

                    <p className="mb-5 text-blue-100 max-w-64 font-robert-regular">Enter the Metagame Layer <br/> Unleash the Play Economy</p>
